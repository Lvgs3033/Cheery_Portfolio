...
import { ExternalLink, Award, ArrowLeft } from "lucide-react" // Added ArrowLeft
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-100 dark:from-pink-900 dark:to-rose-900 transition-all duration-500">
      ...
      <main className="pt-20 px-6">
        <section id="all-certificates" className="py-20">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-800 dark:text-white mb-4">
                All <span className="text-pink-600 dark:text-pink-400">Certificates</span>
              </h2>
              <div className="w-20 h-1 bg-pink-600 mx-auto mb-8"></div>
              <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Explore my complete collection of professional certifications and achievements.
              </p>
            </div>
