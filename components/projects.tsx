...
export default function Projects() {
  ...
  const allProjects = [
    ...
    // Additional projects that show when "View All" is clicked
    {
  ...
  // Show first 6 projects initially, all when showAll is true
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Here are some of my recent projects showcasing my skills in web development, data science, AI/ML, and
            software engineering. Each project demonstrates different technologies and problem-solving approaches.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <Button
            ...
            className="bg-pink-600 hover:bg-pink-700 text-white px-8 py-3 rounded-full transition-all duration-300 hover:scale-105"
          >
            {showAll
              ? `Show Less Projects (${allProjects.length - 6} hidden)`
              : `View All Projects (${allProjects.length - 6} more)`}
          </Button>

          {showAll && (
            <p className="text-gray-600 dark:text-gray-400 mt-4 text-sm">
              Showing all {allProjects.length} projects across Web Development, AI/ML, Data Science, and Full Stack
              categories.
            </p>
          )}
        </div>
