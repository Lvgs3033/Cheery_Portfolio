...
export default function Header() {
  ...
  const navLinks = [
    { name: "Home", href: "/", isAnchor: false }, // Added Home link
    { name: "About", href: "/#about", isAnchor: true },
    { name: "Skills", href: "/#skills", isAnchor: true },
    { name: "Projects", href: "/projects", isAnchor: false }, // Link to dedicated projects page
    { name: "Certificates", href: "/certificates", isAnchor: false }, // Link to dedicated certificates page
    { name: "Blog", href: "/blog", isAnchor: false }, // Link to dedicated blog page
